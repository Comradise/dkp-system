...
namespace dkp_system_back_front.Server.Migrations
{
    ...
    [Migration("20250614151244_InitialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("dkp_system_back_front.Server.Core.Models.Internal.User.InternalUser", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("dkp_system_back_front.Server.Core.Models.Internal.Guild.Member", b =>
                {
                    ...
                    b.HasOne("dkp_system_back_front.Server.Core.Models.Internal.User.InternalUser", null)
                    ...
                    b.HasOne("dkp_system_back_front.Server.Core.Models.Internal.User.InternalUser", "User")
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
